...
export default class stage2 extends Component {
    ...
    storeInfo = () => {
        ...
        this.setState({showInput: !this.state.showInput, selections: prev, currentText: ""})
    }
    recordText = (text) =>
    {
                ...
                <Container className = "user-dashboard-main">
                    ...
                    <div className = "user-dashboard-main-restaurants">
                        ...
                        {this.state.showInput ? 
                            ...
                            <Grid container direction = "row" spacing={10}>
                                <Grid item>
                                    <Button variant = "outlined" onClick = {this.storeInfo}>Confirm</Button>
                                </Grid>
                                <Grid item>
                                    <Button variant = "outlined" onClick = {this.toggle}>Cancel</Button>
                                </Grid>
                            </Grid>
                            </Grid>
